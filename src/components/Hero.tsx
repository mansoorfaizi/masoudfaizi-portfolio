        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="tech-button rounded-lg px-8 py-6 text-base font-medium"
              ...
              <Button 
                variant="outline" 
                className="rounded-lg px-8 py-6 text-base font-medium border-2 border-border hover:border-primary hover:bg-primary/10 tech-card"
